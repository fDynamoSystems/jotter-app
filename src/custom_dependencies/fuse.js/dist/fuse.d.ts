...
declare class Fuse<T> {
  ...
  /**
   * Edits a doc at index.
   */
  editAt(idx: number, newDoc: T): void
  ...
  /**
   * Pseudo removes the doc at the specified index, making it unsearchable.
   * This preserves ref indexes
   */
  pseudoRemoveAt(idx: number): void
  ...
  /**
   * Gets a document at a certain index
   */
  getDoc(idx: number): T | undefined

  /**
   * Gets all the documents within Fuse
   */
  getDocs(idx: number): (T | undefined)[]

  /**
   * Gets the total number of documents within Fuse
   */
  getDocsSize(): number
